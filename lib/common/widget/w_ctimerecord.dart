...
class CTimeRecordWidget extends StatefulWidget {
  final CTimeStorage timeStorage;

  CTimeRecordWidget({Key? key, required this.timeStorage}) : super(key: key);

  @override
  _TimeRecordWidgetState createState() => _TimeRecordWidgetState();
}

class _TimeRecordWidgetState extends State<CTimeRecordWidget> {
